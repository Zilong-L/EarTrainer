...
const getBlackKeyX = (midiNote, startNote) => {
...
const PianoVisualizer = ({ activeNotes = [], detectedChords = [] }) => {
...
function getKeyColor(midiNote, activeMidiNotes, rootMidiNote, isBlackKey) {
