          ...
          <div className="w-48 border-r border-bg-accent bg-bg-common h-full hidden md:block">
            <nav className="p-4 space-y-2 bg-bg-common">
              <button
                ...
                className={`w-full px-4 py-3 text-left rounded-lg ${currentPage === 'game'
              ...
              <button
                ...
                className={`w-full px-4 py-3 text-left rounded-lg ${currentPage === 'practice'
                    ? 'bg-notification-bg text-notification-text'
                    : 'text-text-primary hover:bg-bg-hover'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full px-4 py-3 text-left rounded-lg ${currentPage === 'statistics'
                    ? 'bg-notification-bg text-notification-text'
                    : 'text-text-primary'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full px-4 py-3 text-left rounded-lg ${currentPage === 'volume'
                    ? 'bg-notification-bg text-notification-text'
                    : 'text-text-primary'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full px-4 py-3 text-left rounded-lg ${currentPage === 'sound'
                    ? 'bg-notification-bg text-notification-text'
                    : 'text-text-primary'
                  }`}
              >
                ...
                <div className="p-6">
                  ...
                  <div className="md:hidden">
                    <div className="grid grid-cols-1 gap-4">
                      <button
                        onClick={() => setCurrentPage('game')}
                        className={`p-6 bg-bg-common rounded-lg hover:bg-bg-hover transition-colors ${currentPage === 'game'
                            ? 'bg-notification-bg text-notification-text'
                            : 'text-text-primary hover:bg-bg-hover'
                          }`}
                      >
                      ...
                      <button
                        onClick={() => setCurrentPage('practice')}
                        className={`p-6 bg-bg-common rounded-lg hover:bg-bg-hover transition-colors ${currentPage === 'practice'
                            ? 'bg-notification-bg text-notification-text'
                            : 'text-text-primary'
                          }`}
                      >
