...
const ChordTrainer = () => {
  ...
  const [isSidebarOpen, setIsSidebarOpen] = useState(true); // ChordTrainerSidebar is visible by default
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <ChordTrainerSidebar chordType={chordType} setChordType={setChordType} isOpen={isSidebarOpen} />
